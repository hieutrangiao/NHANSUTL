...
(   ISNULL((SELECT MAX(STToolbarID) +1 FROM dbo.STToolbars),1),   -- STToolbarID - int
    ...
    (SELECT STModuleID FROM dbo.STModules WHERE STModuleName = 'Reward' AND AAStatus = 'Alive'),   -- FK_STModuleID - int
...
--    'Alive', -- AAStatus - varchar(10)
--    (SELECT STToolbarID FROM dbo.STToolbars WHERE STToolbarTag = 'Complete' AND FK_STModuleID = (SELECT STModuleID FROM dbo.STModules WHERE STModuleName = 'Reward' AND AAStatus = 'Alive')),  -- FK_STToolbarID - int
--    'ActionComplete', -- STToolbarFunctionName - varchar(100)
--    'void ActionComplete()', -- STToolbarFunctionFullName - varchar(255)
--    'VinaERP.Modules.Reward.RewardModule'  -- STToolbarFunctionClass - varchar(255)
--    )