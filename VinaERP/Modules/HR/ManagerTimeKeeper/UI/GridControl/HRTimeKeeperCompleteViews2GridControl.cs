...
{
    public partial class HRTimeKeeperCompleteViews2GridControl : VinaGridControl
    {
        ...
        public override void InitGridControlDataSource()
        {
            ...
            bds.DataSource = entity.TimeKeeperCompleteListView2;
            this.DataSource = bds;
        }
        ...
        void rep_Click(object sender, EventArgs e)
        {
            ...
            if (gridView.FocusedRowHandle >= 0)
            {
                ...
                entity.TimeKeeperCompleteListView2.Remove(item);
            }
        }
