...
{
    public partial class HREmployeeWorkScheduleItemsGridControl : VinaGridControl
    {
        ...
        protected override void GridView_KeyUp(object sender, KeyEventArgs e)
        {
            ...
            {
                ((EmployeeWorkScheduleModule)Screen.Module).RemoveSelectedItemFromEmployeeWorkScheduleItemList();
            }
        }
